								...
								<div class="row">
									...
									<div class="col-sm-3" align="right">
										<a style="font-size: 16px;"
											href="<c:url value="/ctl/JasperCtl"></c:url>"
											class="btn btn-primary" role="button" target="blank"> <span
											style="padding-right: 6px;" class="glyphicon glyphicon-print"></span>
										<s:message code="leble.print" />
										</a>
									</div>

									<div class="col-sm-3" align="left">
										<a style="font-size: 16px;"
											href="<c:url value="/Welcome"></c:url>"
