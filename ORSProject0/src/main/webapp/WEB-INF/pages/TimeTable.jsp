							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										width: 180px;" style="padding-top: 13px;"> <s:message
											code="course.label.name" /> <span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6">
										<s:message code="timetable.label.examDate" /> <span
										style="color: red;">*</span>
									</label>
									...
									<div class="col-md-12" style="margin-bottom: 10px;">
										<div class="input-group">
											<span class="input-group-addon"> <i
												class="glyphicon glyphicon-calendar"></i></span>
											<s:message code="timeTable.placeholder.examDate"
												var="examDate"></s:message>
											<sf:input path="examDate" placeholder="${examDate}"
												readonly="true" id="datesun" class="form-control" />
										</div>
									...
									<div class="col-md-12" style="margin-bottom: 10px;">
										<div class="input-group">
											...
											---<s:message code="label.select"></s:message>---
												...
												<sf:option value="2nd" label="2nd">
													<s:message code="TimeTable.semester.2st" />
												</sf:option>
												<sf:option value="3rd" label="3rd">
													<s:message code="TimeTable.semester.3st" />
												</sf:option>
												<sf:option value="4th" label="4th">
													<s:message code="TimeTable.semester.4st" />
												</sf:option>
												<sf:option value="5th" label="5th">
													<s:message code="TimeTable.semester.5st" />
												</sf:option>
												<sf:option value="6th" label="6th">
													<s:message code="TimeTable.semester.6st" />
												</sf:option>
												<sf:option value="7th" label="7th">
													<s:message code="TimeTable.semester.7st" />
												</sf:option>
												<sf:option value="8th" label="8th">
													<s:message code="TimeTable.semester.8st" />
												</sf:option>
