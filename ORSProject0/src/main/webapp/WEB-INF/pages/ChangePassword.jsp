							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="padding-top: 10px;"width: 180px;"> <s:message
											code="label.oldPassword" /> <span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" align="center">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
										style="padding-left: 40px; height: 70px;">
										...
										<button type="submit" class="btn btn-primary"
											style="width: 159px;" name="operation"
