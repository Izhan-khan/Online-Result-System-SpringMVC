					...
					<div class="panel panel-primary"
						...
						<div class="panel-body">
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="padding-top: 10px;"> <s:message
											code="label.name" /> <span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message code="label.address" />
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message code="label.state" />
										<span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message code="label.city" />
										<span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message code="label.phoneNo" />
										<span style="color: red;">*</span>
									</label>
