					...
					<div class="panel-body">
						...
						<sf:form action="Marksheet" method="post" commandName="form">
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<s:message code="marksheet.placeholder.chemistry"
									var="chemistry"></s:message>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="padding-top: 8px;"> <s:message
											code="label.rollNo" /> <span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6">
										<s:message code="label.student" /> <span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message code="label.physics" />
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message
											code="label.chemistry" /> <span style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6"
										style="width: 190px;"> <s:message code="label.maths" />
										<span style="color: red;">*</span>
									</label>
